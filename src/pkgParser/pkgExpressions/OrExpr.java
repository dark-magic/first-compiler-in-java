 ...
 */
public class OrExpr extends AbstrExpression {

	public OrExpr(Scanner s) {
		super(s);
		lhs = new AndExpr(this.scanner);
	}
	...
	public boolean parse() {
		...
		if(isOk) {
			...
			while(scanner.getCurrToken().isValue("or")) {
				String op = scanner.getCurrToken().getValue();
				AbstrExpression rhs_expr = new AndExpr(this.scanner);
